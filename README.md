...
I'm a developer specializing in **AI-driven software**, **autonomous systems**, and **immersive technology**.  
Currently pursuing my **Master of Science in Artificial Intelligence** at **San José State University** (Spring 2026).

I love working at the intersection of machine learning, robotics, and full-stack engineering — turning ideas into real-world systems.
...
### 📜 Resume:
- As of 5 November 2025, <a href="https://github.com/Savant-sys/resume/blob/main/Michael_Khuri_Resume.pdf">resumé</a>
- My portfolio website: https://michaelkhuri.com/

### ⚡ Fun fact:
🏋️‍♂️ Gym  • ✈️ Travel  • 🍳 Cooking  • 🎧 Music  • 🎮 Gaming + VR
...
|--------|------|-------------|
| **Star4ce** | Next.js, Flask, PostgreSQL | Full SaaS employee retention platform (professional paid work) |
| **Detection VR** | Unity, C# | Immersive VR FPS with environmental scanning & physics |
| **Autonomy Vision AI (Coming Soon 👀)** | Python, PyTorch, CV | Lane detection + object tracking AI for robotics/autonomous systems |
...
⭐️ *Always learning. Always building. Autonomy is the future.*
